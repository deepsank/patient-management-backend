...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET","32a0b3980266d0bd49fd1482b7c3750940d379338ebbe80e0fd417b8bca11ed5"));
    ...
    private CfnCluster createMstCluster(){
    ...
    private void createApiGatewayService(){
        ...
        ContainerDefinitionOptions containerOptions =
                ContainerDefinitionOptions.builder()
                        ...
                        .portMappings(List.of(4005).stream()
                                ...
                                .toList())
                        .logging(LogDriver.awsLogs(AwsLogDriverProps.builder()
                                        .logGroup(LogGroup.Builder.create(this, "ApiGatewaLogGroup")
        ...
        ApplicationLoadBalancedFargateService apiGatewat =
